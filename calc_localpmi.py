...
for key, _ in pxy_aichi.items():
    if (pxy_aichi[key] / (px[key] * py_aichi)) > 0:
        pmi_aichi[key] = pxy_aichi[key] * math.log2(pxy_aichi[key] / (px[key] * py_aichi))
